...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case FinishedTaskModelEntityEntity:
			...
			return finishedTaskModelEntityResultFromJson(data as FinishedTaskModelEntityResult, json) as T;			case DiseaseWayModelEntityEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case FinishedTaskModelEntityEntity:
			...
			return finishedTaskModelEntityResultToJson(data as FinishedTaskModelEntityResult);			case DiseaseWayModelEntityEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'FinishedTaskModelEntityEntity':
			...
			return FinishedTaskModelEntityResult().fromJson(json);			case 'DiseaseWayModelEntityEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'FinishedTaskModelEntityEntity':
			...
			return List<FinishedTaskModelEntityResult>();			case 'DiseaseWayModelEntityEntity':
