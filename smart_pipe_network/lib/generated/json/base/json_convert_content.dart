...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UndoneTaskModelEntity:
			...
			return undoneTaskModelResultFromJson(data as UndoneTaskModelResult, json) as T;			case DescribeDetailEntity:
			...
			return loginModelResultUserFromJson(data as LoginModelResultUser, json) as T;			case DetailesImagesEntity:
			return detailesImagesEntityFromJson(data as DetailesImagesEntity, json) as T;			case DetailesImagesResult:
			return detailesImagesResultFromJson(data as DetailesImagesResult, json) as T;			case LocationModelEntity:
			return locationModelEntityFromJson(data as LocationModelEntity, json) as T;			case LocationModelRegeocode:
			return locationModelRegeocodeFromJson(data as LocationModelRegeocode, json) as T;			case LocationModelRegeocodeAddressComponent:
			return locationModelRegeocodeAddressComponentFromJson(data as LocationModelRegeocodeAddressComponent, json) as T;			case LocationModelRegeocodeAddressComponentStreetNumber:
			return locationModelRegeocodeAddressComponentStreetNumberFromJson(data as LocationModelRegeocodeAddressComponentStreetNumber, json) as T;			case LocationModelRegeocodeAddressComponentBuilding:
			return locationModelRegeocodeAddressComponentBuildingFromJson(data as LocationModelRegeocodeAddressComponentBuilding, json) as T;			case LocationModelRegeocodeAddressComponentNeighborhood:
			return locationModelRegeocodeAddressComponentNeighborhoodFromJson(data as LocationModelRegeocodeAddressComponentNeighborhood, json) as T;			case FinishedTaskModelEntityEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UndoneTaskModelEntity:
			...
			return undoneTaskModelResultToJson(data as UndoneTaskModelResult);			case DescribeDetailEntity:
			...
			return loginModelResultUserToJson(data as LoginModelResultUser);			case DetailesImagesEntity:
			return detailesImagesEntityToJson(data as DetailesImagesEntity);			case DetailesImagesResult:
			return detailesImagesResultToJson(data as DetailesImagesResult);			case LocationModelEntity:
			return locationModelEntityToJson(data as LocationModelEntity);			case LocationModelRegeocode:
			return locationModelRegeocodeToJson(data as LocationModelRegeocode);			case LocationModelRegeocodeAddressComponent:
			return locationModelRegeocodeAddressComponentToJson(data as LocationModelRegeocodeAddressComponent);			case LocationModelRegeocodeAddressComponentStreetNumber:
			return locationModelRegeocodeAddressComponentStreetNumberToJson(data as LocationModelRegeocodeAddressComponentStreetNumber);			case LocationModelRegeocodeAddressComponentBuilding:
			return locationModelRegeocodeAddressComponentBuildingToJson(data as LocationModelRegeocodeAddressComponentBuilding);			case LocationModelRegeocodeAddressComponentNeighborhood:
			return locationModelRegeocodeAddressComponentNeighborhoodToJson(data as LocationModelRegeocodeAddressComponentNeighborhood);			case FinishedTaskModelEntityEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UndoneTaskModelEntity':
			...
			return UndoneTaskModelResult().fromJson(json);			case 'DescribeDetailEntity':
			...
			return LoginModelResultUser().fromJson(json);			case 'DetailesImagesEntity':
			return DetailesImagesEntity().fromJson(json);			case 'DetailesImagesResult':
			return DetailesImagesResult().fromJson(json);			case 'LocationModelEntity':
			return LocationModelEntity().fromJson(json);			case 'LocationModelRegeocode':
			return LocationModelRegeocode().fromJson(json);			case 'LocationModelRegeocodeAddressComponent':
			return LocationModelRegeocodeAddressComponent().fromJson(json);			case 'LocationModelRegeocodeAddressComponentStreetNumber':
			return LocationModelRegeocodeAddressComponentStreetNumber().fromJson(json);			case 'LocationModelRegeocodeAddressComponentBuilding':
			return LocationModelRegeocodeAddressComponentBuilding().fromJson(json);			case 'LocationModelRegeocodeAddressComponentNeighborhood':
			return LocationModelRegeocodeAddressComponentNeighborhood().fromJson(json);			case 'FinishedTaskModelEntityEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UndoneTaskModelEntity':
			...
			return List<UndoneTaskModelResult>();			case 'DescribeDetailEntity':
			...
			return List<LoginModelResultUser>();			case 'DetailesImagesEntity':
			return List<DetailesImagesEntity>();			case 'DetailesImagesResult':
			return List<DetailesImagesResult>();			case 'LocationModelEntity':
			return List<LocationModelEntity>();			case 'LocationModelRegeocode':
			return List<LocationModelRegeocode>();			case 'LocationModelRegeocodeAddressComponent':
			return List<LocationModelRegeocodeAddressComponent>();			case 'LocationModelRegeocodeAddressComponentStreetNumber':
			return List<LocationModelRegeocodeAddressComponentStreetNumber>();			case 'LocationModelRegeocodeAddressComponentBuilding':
			return List<LocationModelRegeocodeAddressComponentBuilding>();			case 'LocationModelRegeocodeAddressComponentNeighborhood':
			return List<LocationModelRegeocodeAddressComponentNeighborhood>();			case 'FinishedTaskModelEntityEntity':
